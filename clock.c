...
#define APLL_CON_VAL  ((1<<31) | (266 << 16) | (3 << 8) | (1)) //MDIV(16：25)：266 PDIV（8：13）:3 SDIV（0：2）:1
...
void clock_init(void)
{
	...
	Use asynchronous interface mode at SYNC667 mode if ARM_RATIO, HCLKX2_RATIO, and HCLK_RATIO of
    CLK_DIV0 are different values from 0x0, 0x0, and 0x1*/
